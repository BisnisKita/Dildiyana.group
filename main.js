...
fungsiAwal = 0;
fungsitimer = 0;
pesanWA = pesanWA.innerHTML;
deffotostiker = fotostiker.src;
Content.style = "opacity:1;margin-top:30vh;";
...
function ftmuncul() {
  ...
  if (ftganti == 8) {
    fotostiker.src = fotostiker9.src;
  }
  if (ftganti == 9) {
    fotostiker.src = fotostiker10.src;
  }
...
function akhiran2() {
  bq.style = "border:0;background:none;box-shadow:none";
  kalimat.innerHTML = "";
...
function anikal() {
  if (opsLcheck !== jumlahP) {
    ...
    kalimat.style = "opacity:1;transform:scale(1.2);";
  }
}
function otopsL() {
  if (opsLcheck != 2) {
...
function prbhn() {
  if (opsLcheck == jumlahP - 1) {
    kecepatan = 55; /*var prg = document.getElementById("kalimat");prg.classList.add("kiri");*/
  }
}
...
async function menuju() {
  window.location = "https://wa.me/6285758492957/send?phone=&text=" + pesanWA;
  muncultombol3();
}
...
function muncultombol2() {
  resetPosisi();
  fungtom = 2;
  By.innerHTML = penggantiBy.innerHTML;
  Bn.innerHTML = penggantiBn.innerHTML;
  Tombol.style = "opacity:1;transform:scale(1)";
}
